...
namespace OnlineShop.DataLayer.SQLite.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresAtTime = table.Column<DateTime>(nullable: false),
                    SlidingExpirationInSeconds = table.Column<long>(nullable: true),
                    AbsoluteExpiration = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
